...
expect(readme.includes("releases/download/v1.1.0/PokeFollower-1.1.0.AppImage"), "README must link the v1.1.0 Linux AppImage asset");
expect(!readme.includes("v1.1.0 の Release には AppImage asset をまだ添付していない"), "README must not keep the stale missing Linux AppImage note");
