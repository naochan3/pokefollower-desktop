...
expect(status.includes("現在のバージョン: **v1.1.0**"), "STATUS must state current version v1.1.0");
expect(status.includes("現在含まれているもの（v1.1.0）"), "STATUS must have included-assets section for v1.1.0");
...
expect(readme.includes("v1.1.0 の Linux AppImage は Release へ未添付"), "README must state the v1.1.0 Linux AppImage asset is not attached yet");
expect(!readme.includes("releases/download/v1.1.0/PokeFollower-1.1.0.AppImage"), "README must not link a missing v1.1.0 Linux AppImage asset");
