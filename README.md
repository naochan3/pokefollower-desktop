...
- **素材（MIT対象外）**：ポケモンのスプライト（`assets/`）・名称・モンスターボール/アイコン等の Pokémon 関連素材は **MIT の対象外**です。各権利者（Nintendo / Creatures Inc. / GAME FREAK inc. および素材提供元）に帰属し、非商用の個人的ファン制作物として同梱しているだけです。
