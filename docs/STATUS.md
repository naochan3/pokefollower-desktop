...
最終更新: 2026-06-19 / 現在のバージョン: **v1.0.3**
...
- Windows インストーラ＋zip（Electron 42・Rust コア同梱、PR #11/#18/#21 の改善込み。追従既定 16ms）
- macOS arm64 dmg / zip（v1.0.3 は contributor によるビルド添付待ち。直近の公開済み安定版は v1.0.2）
- ポケモン 493 種（第1〜4世代）
