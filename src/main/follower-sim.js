...
function createFollowerSim(options = {}) {
  const CONFIG = { scale: 1.25, offset: 70, lerp: 0.20, edgeRest: true, avoidCursor: true };
  ...
  function applyConfigPatch(obj = {}) {
    ...
    if (rustCore) rustCore.setConfig({ offset: CONFIG.offset, lerp: CONFIG.lerp, avoidCursor: CONFIG.avoidCursor });
